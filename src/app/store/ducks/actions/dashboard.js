...
const actions = {
  ...
  getUserOverview: params => ({
    type: actionTypes.GET_USER_OVERVIEW_REQUEST,
    payload: params
  }),
  getTutorialOverview: params => ({
    type: actionTypes.GET_TUTORIAL_OVERVIEW_REQUEST,
    payload: params
  }),
  getCommentOverview: params => ({
    type: actionTypes.GET_COMMENT_OVERVIEW_REQUEST,
    payload: params
  }),
  getViewOverview: params => ({
    type: actionTypes.GET_VIEW_OVERVIEW_REQUEST,
    payload: params
  })
};
...
export function* dashboardSaga() {
  ...
  yield takeLatest(
    actionTypes.GET_TUTORIAL_OVERVIEW_REQUEST,
    fetchTutorialOverview
  );
  yield takeLatest(
    actionTypes.GET_COMMENT_OVERVIEW_REQUEST,
...
function* fetchTutorialOverview(action) {
  try {
    const response = yield call(
      dashboardApi().getTutorialOverview,
      action.payload
    );
    const { data } = response;
    ...
    yield put({
      type: actionTypes.GET_TUTORIAL_OVERVIEW_SUCCESS,
      payload: data
    });
  } catch (error) {
    yield put({
      type: actionTypes.GET_TUTORIAL_OVERVIEW_ERROR,
      payload: error
    });
  }
}
function* fetchCommentOverview(action) {
  try {
    const response = yield call(
      dashboardApi().getCommentOverview,
      action.payload
    );
    const { data } = response;
    ...
    yield put({
      type: actionTypes.GET_COMMENT_OVERVIEW_SUCCESS,
      payload: data
    });
  } catch (error) {
